...
if ($client->getRet() == PhalApiClient::RET_OK) {
    ...
    $order = $rs['content'];
//    $page_html = Pagination::showPager("return_order_details.php?orderId=" . $orderId, $page_no, $page_size ,$row_count);
} else {
...
Template::assign('url', 'return_order_add');
Template::assign('modify_url', 'return_order_modify');
Template::assign('delete_url', 'return_order_delete');

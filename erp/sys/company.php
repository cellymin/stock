...
$res = $client->request('Company_GetList.Go',array(
...
if ($client->getRet() == PhalApiClient::RET_OK) {
   ...
   $page_html=Pagination::showPager("company.php?keyword=$keyword",$page_no,$page_size,$row_count); 
}
Template::assign ( 'list', $list );
Template::assign ( 'page_html', $page_html );
Template::assign ( '_GET', $_GET );
Template::display('sys/company.tpl');
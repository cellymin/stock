...
Template::assign('url', 'purchase_return_add');
Template::assign('modify_url', 'purchase_return_modify');
Template::assign('delete_url', 'ip_return_goods_delete');
Template::assign('toReview', 'preturn_to_review');
Template::assign('review', 'preturn_review');
Template::assign('type', 'PURCHASE_RETURN');

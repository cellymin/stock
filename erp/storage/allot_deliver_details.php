...
Template::assign('url', 'allot_deliver_add');
Template::assign('modify_url', 'allot_deliver_modify');
Template::assign('delete_url', 'od_goods_delete');
Template::assign('toReview', 'od_to_review');
Template::assign('review', 'allot_deliver_review');

...
if ($client->getRet() == PhalApiClient::RET_OK) {
    ...
    $order     = $rs['content'];
//    $page_html = Pagination::showPager("allot_storage_details.php?orderId=".$orderId, $page_no, $page_size, $row_count);
} else {
...
Template::assign('url', 'allot_storage_add');
Template::assign('modify_url', 'allot_storage_modify');
Template::assign('delete_url', 'id_goods_delete');
Template::assign('toReview', 'id_to_review');
Template::assign('review', 'allot_storage_review');
Template::assign('type', 'ALLOT_IN');

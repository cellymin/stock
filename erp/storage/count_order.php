...
if ($client->getRet() == PhalApiClient::RET_OK) {
    ...
    $page_html = Pagination::showPager("count_order.php?keyword=$keyword&status=$status", $page_no, $page_size,
        $row_count);
} else {
...
Template::assign('create_url', 'count_order_create');
Template::assign('details_url', 'count_order_details');
Template::assign('delete_url', 'pd_delete');

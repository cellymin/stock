...
function beforedao(){
    $('#data_list1').children().children().eq(0).css('display','');
    $('#data_list1').children().children().eq(1).css('display','');
    method5('data_list1')
    $('#data_list1').children().children().eq(0).css('display','none');
    $('#data_list1').children().children().eq(1).css('display','none');
}
</script>	

...
<head>
    ...
    <link rel="stylesheet" href="<{$smarty.const.ADMIN_URL}>/assets/lib/layer/skin/default/layer.css">
    ...
    <script src="<{$smarty.const.ADMIN_URL}>/assets/js/extend.js"></script>
    <script src="<{$smarty.const.ADMIN_URL}>/assets/lib/layer/layer.js"></script>
    <script src="<{$smarty.const.ADMIN_URL}>/assets/lib/echarts.min.js"></script>
   <{* <script src="<{$smarty.const.ADMIN_URL}>/assets/lib/jquery.jqprint-0.3.js"></script> *}>
    <script src="<{$smarty.const.ADMIN_URL}>/assets/lib/jQuery.print.min.js"></script>

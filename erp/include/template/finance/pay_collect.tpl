    ...
    <form id="" method="post" action="" enctype="multipart/form-data">
        <table width="100%" class="table">
            ...
            <tr>
                ...
                <td colspan="3"> <b><input type="text" name="adjustamount" style="font-size: 14px;" value="<{$list.adjustamount}><{if $lionidinfo[2]!=''}><{$lionidinfo[2]}><{else}>+<{sprintf('%.2f',$list.adjustamount)}><{/if}>" /></b></td>
            </tr>
            <tr>
                <td>财务类型</td>

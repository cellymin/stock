...
<div class="form_div">
    <form method="post" action="allot_deliver_add.php">
        <table>
            <tbody>
            <tr>
                <td width="100">商品</td>
            ...
            <tr>
                <td>数量</td>
                <td><input name="goodsCnt" type="text" value="<{$_GET.goodsCnt}>" required></td>
            </tr>
            <tr>
                <td>备注</td>
                <td><textarea name="remark" id="" cols="30" rows="5" style="resize: none"><{$_GET.remark}></textarea></td>
            </tr>
            <tr>
                <td>
...
<script type="text/javascript">
    $(function(){
        $('#departmentId').change(function(){
            ...
            window.location.href = "allot_deliver_add.php?method=options&orderId=<{$orderId}>&id=<{$goods.id}>&departmentId="+departmentId
        })
    })
</script>

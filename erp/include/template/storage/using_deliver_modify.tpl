...
<div class="form_div">
    <form method="post" action="using_deliver_modify.php">
        <table>
            <tbody>
            <tr>
                <td>商品</td>
...
<script type="text/javascript">
    $(function(){
        $('#departmentId').change(function(){
            ...
            window.location.href = "using_deliver_modify.php?method=options&orderId=<{$orderId}>&id=<{$id}>&departmentId="+departmentId
        })
    })
</script>

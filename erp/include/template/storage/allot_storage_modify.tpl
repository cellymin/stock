...
<div class="form_div">
    <form method="post" action="allot_storage_modify.php">
        <table>
            <tbody>
            <tr>
                <td>商品</td>
            ...
            <tr>
                <td>供应商</td>
                <td><{html_options name=supplierId id="DropDownTimezone" required="true" options=$suppliers_options selected=$goods.supplierId}></td>
            </tr>
            <tr>
                <td>库位</td>
                <td><{html_options name=depotSubId id="DropDownTimezone" required="true" options=$depotSubs_options selected=$goods.depotSubId}></td>
            </tr>
            <tr>
                <td>数量</td>

...
class User extends Base{
	...
	// 查询字段
	private static $columns = 'user_id, user_name, password, real_name, mobile, email, user_desc, login_time, status, login_ip, user_group, template,shortcuts,show_quicknote,companyId,departmentId,employeeId,selectAll';
	//状态定义
	const ACTIVE = 1;
	const DEACTIVE = 0;

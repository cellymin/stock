<?php /* Smarty version Smarty-3.1.15, created on 2017-10-18 15:04:15
         compiled from "E:\wwwroot\jxc.com\erp\include\template\finance\collect.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2443659e6fcef5aa5b5-66324542%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8336855ddd14d17f16bd646f15168ab360d2c4e4' => 
    array (
      0 => 'E:\\wwwroot\\jxc.com\\erp\\include\\template\\finance\\collect.tpl',
      1 => 1508292866,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2443659e6fcef5aa5b5-66324542',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59e6fcef681362_66692723',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59e6fcef681362_66692723')) {function content_59e6fcef681362_66692723($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include 'E:\\wwwroot\\jxc.com\\erp\\include\\config/../../include/lib/Smarty/plugins\\function.html_options.php';
...
<form class="form_search" action="" method="GET" style="margin-bottom:0px">
    <div class="btn-toolbar" style="float:right;padding-top:15px;">
        <a class="btn btn-primary layerModel" action="4" title="新增财务" layerUrl="collect_add" layerW="850px"
    ...
    <div style="float:left;margin-right:5px">
        ...
        <select name="payStatus" id="">
            ...
            <option value="1" <?php if ($_smarty_tpl->tpl_vars['_GET']->value['payStatus']==1) {?>selected<?php }?>>未收款</option>
            <option value="2" <?php if ($_smarty_tpl->tpl_vars['_GET']->value['payStatus']==2) {?>selected<?php }?>>已收款</option>
        </select>
    </div>
    <div style="float:left;margin-right:5px">
        <label>选择客户</label>

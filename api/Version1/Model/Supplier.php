...
class Model_Supplier extends PhalApi_Model_NotORM
{
    ...
    {
        return 'supplierId,supplierName,supplierAddress,supplierTel,supplierUserName,supplierUserPhone,supplierUserEmail,supplierUserQQ,bankName,bankAccount,bankOpenName,cardUserName,cardUserPhone,cardMoney,remark,reviewer,reviewTime,flag,taxrate,quanpin,jianxie';
    }
    ...
    public function appGetlist(){
        ...
        return DI()->notorm->suppliers
            ->select('supplierId,supplierName,taxrate')->where('flag',1)
            ->fetchAll();
    }
}
...
class Api_DepotGoods_GetListNo extends PhalApi_Api
{
    public function getRules()
    {
        return array(
            'go' => array(
                ...
                'depotId'    => array('name' => 'depotId', 'type' => 'int', 'min' => 0, 'require' => false),
                'depotSubId' => array('name' => 'depotSubId', 'type' => 'int', 'min' => 0, 'require' => false),
            )
        );
    }

...
DI()->request = new Common_Request($_POST);

//自定义参数规则
DI()->_formatterEmail = 'Common_Formatter_Email';
DI()->_formatterPhone = 'Common_Formatter_Phone';
DI()->_formatterTel = 'Common_Formatter_Tel';
DI()->_formatterAuth = 'Common_Formatter_Auth';
DI()->_formatterName = 'Common_Formatter_Name';
DI()->_formatterBank = 'Common_Formatter_Bank';
